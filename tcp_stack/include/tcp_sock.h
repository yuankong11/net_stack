...
#define TCP_MAX_BACKLOG 128
	...
	// next to be acked by peer
	u32 snd_una;
	// next byte to send
	u32 snd_nxt;

	// the byte expected to receive next
	u32 rcv_nxt;
	...
	pthread_mutex_t adv_wnd_lock;
	pthread_mutex_t rcv_wnd_lock;
